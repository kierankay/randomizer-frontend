    ...
    <div className="card card-header my-3" style={{ backgroundColor: 'rgb(218, 248, 226)' }}>
      ...
      <div>
        {addingStudent
          ...
          : <div className="d-block"><button type="button" className="btn btn-primary mt-3" onClick={() => setAddingStudent(!addingStudent)}>Add Student</button></div>}
      </div>
    </div>
  );
};
